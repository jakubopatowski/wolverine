...
class CMakeCreator:
    ...
    def add_target(self, file, target_type, lib_type=LibraryType.UNKNOWN):
        ...
        if target_type == TargetType.UNKNOWN:
            ...
            or target_type == TargetType.HEADER_LIBRARY
        ):
    ...
    def __add_includes(
        self, file, includes, excludeList=None, is_qt4=False, is_qt5=False
    ):
        assert isinstance(file, IOBase)
        ...
        if is_qt4 == True:
            ...
            file.write(
                '    "../thirdparty/qt-4.8.7-stl521/mkspecs/win'
                + self.bit_type
                + '-msvc2017"\n'
            )
        ...
        if is_qt5 == True:
            ...
            file.write(
                '    "../thirdparty/qt-5.12.5/mkspecs/win'
                + self.bit_type
                + '-msvc2017"\n'
            )
        file.write(")\n\n")
    ...
    def create_project(self, path, build_data):
        ...
        if build_data.is_there_qt5:
            self.__add_qt_support(file, build_data.list_of_qt_targets, "5.12.5")
